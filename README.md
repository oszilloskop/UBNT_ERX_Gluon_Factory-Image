...
Die hier downloadbaren generischen Gluon-Factory-Images können direkt über das Web-GUI der UBNT-Stockfirmware geflasht werden. Sie bieten dann **danach** dem Nutzer die Möglichkeit, über die Gluon-Konfigseite ein Sysupgrade-Image einer **beliebigen Community** aufzuspielen. Die komplett abgespeckten generischen Gluon-Factory-Images sind ansonsten funktionslos.  
